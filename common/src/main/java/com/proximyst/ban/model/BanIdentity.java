...
public abstract class BanIdentity {
  ...
  public static final class UuidIdentity extends BanIdentity {
    ...
    public @NonNull CompletableFuture<@NonNull Iterable<@NonNull IBanAudience>> audiences() {
      final IBanAudience audience = banServer.audienceOf(this.uuid);
      if (audience == null) {
  ...
  @Singleton
  public static final class ConsoleIdentity extends BanIdentity {
